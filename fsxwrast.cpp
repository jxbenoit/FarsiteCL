/*============================================================================
  ...
  Rasterizing interpolation functions for FARSITE.
  ============================================================================
*/
#include<time.h>
#include"fsglbvar.h"
...
//============================================================================
void Rasterize::rasterinit( long CurrentFire, long ExNumPoints,
                            double SIMTIME, double TimeIncrement,
                            double CuumTimeIncrement )
{ //Rasterize::rasterinit
  CallLevel++;

  if( Verbose >= 8 )
    printf( "%*sfsxwrast:Rasterize::rasterinit:1\n", CallLevel, "" );

  GetRasterExtent();
  count = CurrentFire;
  ExNumPts = ExNumPoints;
  //Calc time in hours.decimals.
  CurTime = ( SIMTIME / 60.0 ) + CuumTimeIncrement / 60.0;
...
void Rasterize::RasterReset()
{
  ...
  //AAA AllocRastData(50);  In JAS! ver only
}
...
void Rasterize::raster()
{
	...
	//SelectMemOutputs(GetRastFormat());	// write to raster file  AAA JAS! ver only
	if (ExNumPts > 0)
	{
		ExNumPts = 0;
				...
				for (E = 0; E < noeast; E++)
				{
						...
						N++)   		 	// XUtilities public data members
					{
						...
						if (inside)
						{
							...
							{
							case 0:
                //AAAmap[loc] = (WrT * 18.60) * ConvHeat;	// MJ, or MBtu  JAS! ver
                map[loc] = WrT * ConvHeat;  // MJ, or MBtu  AAA FromG5 ver
								break;
							case 1:
								map[loc] = WrT * ConvWt;
								break;
